...
export const createUserRequestShape: SchemaOf<IUserRegisterRequest> = yup
  .object()
  .shape({
...
export const createUserResponseShape: SchemaOf<IUserRegisterResponse> = yup
  .object()
  .shape({
    createdAt: yup.date(),
...
export const updateUserRequestShape: SchemaOf<IUserUpdateRequest> = yup
  .object()
  .shape({
