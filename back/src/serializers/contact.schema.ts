...
import {
  IContactCreateResponse,
  IContactCreateRequest,
} from "../interfaces/contact";

export const createContactRequestShape: SchemaOf<IContactCreateRequest> = yup
  .object()
  .shape({
...
export const createContactResponseShape: SchemaOf<IContactCreateResponse> = yup
  .object()
  .shape({
    createdAt: yup.date(),
    phone: yup.string().max(20).required(),
